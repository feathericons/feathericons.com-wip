...
function Sponsor({ className, sponsor }: SponsorProps) {
	return (
...
export default function Header() {
	...
	return (
		<div className="relative">
			{/* TODO: Extract colors. */}
			<header className="px-16 lg:px-24 py-96" style={{ backgroundImage: "linear-gradient(90deg, #0065ff, #7648ff)" }}>
				<div className="hstack">
					{/* NOTE: Uses `z-10` becaused of `<svg>` background. */}
					<div className="vstack xl:hstack space-48 w-full max-w-lg z-10">
						{/**/}
