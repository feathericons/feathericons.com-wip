...
function LogoAndCTA() {
	return (
		...
		<div className="flex flex-col items-center" style={{ width: "100%", maxWidth: "26rem" }}>
			...
			{/* Logo */}
			{/* <Style className="w-16 h-16 text-white"> */}
			...
			<div className="flex flex-col sm:flex-row w-full sm:w-auto">
				<div className="flex flex-row justify-center items-center w-auto sm:w-48 h-14 bg-white bg-opacity-95 border border-white border-opacity-10 rounded-6">
				...
				<div className="flex flex-row justify-center items-center w-auto sm:w-48 h-14 bg-white bg-opacity-20 border border-white border-opacity-10 rounded-6">
