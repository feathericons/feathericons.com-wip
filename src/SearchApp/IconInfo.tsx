...
//
// 	return (
// 		<div className="grid-bento -mx-16 sm:mx-0">
// 			<div className="hstack border-1">
// 				<GitHub className="ui-svg" style={{ width: rem(dimensions[0]!), height: rem(dimensions[0]!) }} />
// 			</div>
// 			<div className="hidden lg:unhidden hstack border-1">
// 				<GitHub className="ui-svg" style={{ width: rem(dimensions[1]!), height: rem(dimensions[1]!) }} />
// 			</div>
// 			<div className="hidden lg:unhidden hstack border-1">
// 				<GitHub className="ui-svg" style={{ width: rem(dimensions[2]!), height: rem(dimensions[2]!) }} />
// 			</div>
// 			<div className="hidden lg:unhidden hstack border-1">
// 				<GitHub className="ui-svg" style={{ width: rem(dimensions[3]!), height: rem(dimensions[3]!) }} />
// 			</div>
// 		</div>
// 	)
// }
...
// 		//
// 		// prettier-ignore
// 		<div className="hstack -mx-16 sm:mx-0 -mt-1 sm:mt-0 bg-gray-50 border-1 sm:rounded-6">
// 			{children}
// 		</div>
// 	)
// }
...
// 					<GitHub className="w-18 h-18 ui-svg" />
...
// 				<div className="hstack space-16 px-16 h-48">
// 					<Lock className="w-18 h-18 ui-svg" />
// 					<div className="spacer overflow-x-scroll">
