...
[Duomo CSS](https://github.com/zaydek/duomo).<br />
[Both are licensed as MIT](https://github.com/feathericons/feather/blob/master/LICENSE). Icons may be used personally
and commerically _without_ attribution. <span style={{fontSize: "1.25em", lineHeight: 1}}>👌</span>
