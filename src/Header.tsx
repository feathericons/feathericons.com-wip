...
export default function Header() {
	return (
		<div className="zstack">
			<div className="hstack px-16 sm:px-24" style={{ justifySelf: "stretch" }}>
				<div className="vstack xl:hstack space-32 py-96 w-full" style={{ maxWidth: 1088 }}>
					...
					<div className="vstack space-24">
						...
						<div className="mt-32 w-192 h-24 bg-placeholder rounded-full"></div>
						<div className="mt-16 w-320 h-8 bg-placeholder rounded-full"></div>
						{/* CTA buttons */}
			...
			<div className="top-0 inset-x-0 px-16 sm:px-24">
				<TopAnchors />
			</div>
		</div>
	)
